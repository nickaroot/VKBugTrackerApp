...
//
    class func userInfo() {
        VK.API.Users.get([.userIDs: userId, .fields: "photo_200"])
            .onSuccess {
                ...
                userAvatarUrl = URL(string: dict!["photo_200"]! as! String)
                
                DispatchQueue.main.async {
                    guard let imageData = try? Data(contentsOf: userAvatarUrl!) else {
